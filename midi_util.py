...
def midi_to_array_one_hot(mid, quantization):
    ...
    notes = [
        ...
        for (time, msg) in list(zip(cum_times, time_msgs))
...
def quantize_track(track, ticks_per_quarter, quantization):
    ...
    for diff_time, (cum_time, msg) in list(zip(diff_times, quantized_msgs)):
